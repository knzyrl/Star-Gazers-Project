...
public class AstronomyCalculations {
    ...
    // Sourced from https://www.ssec.wisc.edu/mcidas/software/v/javadoc/1.01/src-html/edu/wisc/ssec/mcidasv/data/
    // adde/sgp4/Sidereal.html
    /**
    ...
    private static double calcGmst(String date) {
        ...
        // do calculation
        double gmst = ((280.46061837 + 360.98564736629 * (mjd - 51544.5))
    ...
    /**
     * Main method for testing the functionality of astronomical calculations.
     * Demonstrates the calculation of GMST and RA for a sample longitude and date.
     *
